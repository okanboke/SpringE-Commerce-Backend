...
public class JwtUserDetails implements UserDetails {
    ...
    public JwtUserDetails(Long id, String username, String password, Collection<? extends GrantedAuthority> authorities) {
        this.id = id; //bir user geldiğinden ondan bir user details objesi dönüyoruz...
        this.username = username;
        this.password = password;
        this.authorities = authorities;
    }

    public static JwtUserDetails create(User user) { //Auth için kullanacağımız User Objemiz...
